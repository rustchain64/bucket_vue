          ...
          >
            ...
            <div class="form-row">
              ...
              <div class="form-group" id="agent-group-width">
                ...
                <button
                  @click="getAgentCode(tutorial.agentName)"
...
export default {
  ...
  methods: {
    redirect_to_login() {
      console.log("COMMIT FORM VALUES TO STORE v-model : ", this.referral);
      console.log(
        ">>>>>>>>>> this is for after login to restore values to form"
      );
      ...
      // commit form data
      referralStore.register(this.referral);
    },
    saveReferral() {
      var data = {

    ...
    >
      <div class="form-row">
        <div class="form-group col">
          ...
          <!-- For a Referral ADD it should be merchant not Merchant is true or false? -->
          ...
          <Field
            ...
            type="text"
            class="form-control"
            :class="{ 'is-invalid': errors.personaType }"
          />
          <div class="invalid-feedback">{{ errors.personaType }}</div>
        </div>
        <div class="form-group col">
